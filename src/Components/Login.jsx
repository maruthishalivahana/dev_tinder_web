...
function Login() {
    ...
    const handleToggle = () => setLogin(!isLogin)
                    ...
                    <div className="card-body">
                        <fieldset className="fieldset">
                            ...
                            <div className='flex justify-around '>
                                ...
                                <div>
                                    <p>{isLogin ? "if don't have account" : "if you have a account"}
                                        <span className='text-blue-400 hover:underline cursor-pointer' onClick={handleToggle}>
